                    ...
                    for (let j = 0; j < this.data.gameHistory.length; j++) {
                        if (
                            ...
                            this.displayHisOpponent(
                                this.data.gameHistory[j][this.opponentGamePlayerId] // showing hits on me
                            );
                        }
                    }
}
...
this.bothShips = false;
                    ...
                    } else if (this.data.waitForOpponent) { // check for waiting view
                        this.waiting = true;
                    } else if (this.thisPlayerSalvoes[this.thisGamePlayerId].length === 0) { // check for first salvo
